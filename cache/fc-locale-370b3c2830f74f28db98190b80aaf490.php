<?php return array (
  'context.current' => 'Testata attuale:',
  'context.select' => 'Passa ad un altra rivista:',
  ...
  'navigation.skip.about' => 'Vai alla testata',
  ...
  'user.reviewerPrompt' => 'Sei disponibile a revisionare articoli per questa testata?',
...
<li>Usa <strong>*</strong> in un termine come jolly per mascherare una serie di caratteri; es., <em>soci* morality</em> troverà documenti contenenti "sociological" sia "societal"</li>
  ...
  'about.editorialTeam' => 'Comitato Scientifico ed Editoriale',
  ...
  'about.onlineSubmissions.submitToSection' => 'Invia un nuovo contributo per la sezione <a href="{$url}">{$name}2</a> .',
  ...
  'payment.notFound' => 'E\' stato richiesto un pagamento, ma sono scaduti i termini. Contattare il responsabile della testata per ulteriori dettagli.',
...
<p>Se non hai ancora effettuato la registrazione e vuoi ricevere news e aggiornamenti, <strong>registrati a  <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>.</strong>Se hai commenti o domande, visita il <a href="http://forum.pkp.sfu.ca" target="_new">forum del supporto</a>.</p>',
  ...
  'manager.setup.clockssDescription' => '
supporta ancche CLOCKSS (Controlled Lots of Copies Keep Stuff Safe) "
sistema per avere una sicura e permanente archiviazione della "
Se la tua rivista ha siglato un contratto con il  CLOCKSS "
attivalo qui:"',
  'manager.setup.porticoDescription' => '
è un servizio no-profit per la preservazione delle pubblicazioni "
Se la tua rivista ha siglato un contratto con Portico, attivalo "
',
);