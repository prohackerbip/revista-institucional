<?php return array (
  'user.authorization.journalDoesNotPublish' => 'Esta revista no publica su contenido en línea',
...
<li>Utilice <strong>*</strong> en un término como comodín para que cualquier secuencia de caracteres concuerde; p. ej., <em>soci* moralidad</em> hará que aparezcan aquellos documentos que contienen "sociológico" o "social"</li>
  ...
  'installer.updatingInstructions' => 'Si estás actualizando una instalación de OJS ya existente, haz <a href="{$upgradeUrl}">clic aquí</a> para continuar',
...
es un servicio sin ánimo de lucro comprometido con la "
de las publicaciones digitales, entre las que se incluyen "
y libros electrónicos y colecciones históricas digitalizadas. Si "
revista ha firmado un contrato con Portico actívelo aquí:"',
);