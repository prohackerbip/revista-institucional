<?php return array (
  ...
  'user.login.lostPassword.confirmationSentFailedWithReason' => 'mpossibile completare la richiesta di reimpostazione della password perché {$reason}.',
  ...
  'user.login.resetPassword.passwordUpdated' => 'La password è stata aggiornata con successo. Effettua il login con la password aggiornata.',
  ...
  'user.login.passwordResetProcessInstructions' => 'Inserisci la nuova password per aggiornare la password di accesso.',
