<?php return array (
  ...
  'manager.distribution.copyrightYearBasis.description' => 'Seleziona la modalità di assegnazione in automatico della data di copyright. Questa potrà essere modificata manualmente. Se la testata è a pubblicazione continua non utilizzare la data di pubblicazione del singolo fascicolo.',
  ...
  'manager.distribution.publishingMode.subscription' => 'Questa testata richiede un abbonamento per accedere a tutti o a parte dei contenuti.',
  'manager.website.archiving' => 'Archiviazione',
  'manager.emails.confirmResetAll' => 'Sei sicuro di voler ripristinare tutti i modelli di email di questa rivista? In questo modo verranno perse tutte le personalizzazioni effettuate.',
  ...
  'manager.section.noSectionEditors' => 'Non ci sono editor di sezione. Aggiungi questo ruolo almeno ad un utente con >Impostazioni >Utenti e Ruoli.',
  'manager.sections.assigned' => 'Editor di questa sezione',
  'manager.sections.confirmDelete' => 'Sei sicuro di voler cancellare definitivamente questa sezione? Se sì dovrete ripubblicare tutti gli articoli attualmente presenti.',
  'manager.sections.alertDelete' => 'Prima di cancellare questa sezione, devi spostare in un\'altra tutti gli articoli pubblicati che contiene.',
  'manager.sections.create' => 'Crea una sezione',
  'manager.section.sectionEditorInstructions' => 'Aggiungi un Section Editor a questa sezione per assegnargli automaticamente le proposte inviate a questa sezione (comunque potrai sempre assegnare manualmente un SE, quando arriva ciascuna proposta).
Una volta aggiunto, il SE sarà automaticamente assegnato  alla gestione della REVISIONE (peer review) e/o dell\'EDITING (copyediting, layout e correzione delle bozze) delle submission di questa sezione. I SE vengono creati cliccando \'Section editor\' nel menù dei ruoli nella pagina di gestione della rivista.',
  ...
  'manager.setup' => 'Setup',
  'manager.setup.masthead' => 'Testata',
  'manager.setup.editorialTeam' => 'Team editoriale',
  ...
  'manager.setup.alternateHeader' => 'Testata alternativa',
  'manager.setup.alternateHeaderDescription' => 'In alternativa, invece del titolo e del logo, è possibile inserire una versione in HTML della testata, utilizzando il box di testo sottostante. Per non modificare nulla, lascia il box vuoto.',
  ...
  'manager.setup.emailSignature.description' => 'Le email inviate in automatico dal sistema avranno la seguente firma alla fine del messaggio. Il contenuto di queste email può essere modificato nella sezione di amministrazione della rivista.',
  ...
  'manager.setup.form.journalTitleRequired' => 'Inserire il titolo della testata.',
  ...
  'manager.setup.identity' => 'ID della testata',
  ...
  'manager.setup.information.description' => 'Breve descrizione della testata per bibliotecari e potenziali autori e lettori, disponibile nella sezione "Informazioni" del menu laterale.',
  ...
  'manager.setup.keyInfo.description' => 'Inserire una descrizione della testata e identifica gli Editors, i direttori responsabili ed altri membri del team editoriale.',
  ...
  'manager.setup.look.description' => 'Testata dell\'homepage, contenuto, testata della rivista, pie\' di pagina, menu di navigazione e fogli di stile.',
  ...
  'manager.setup.publicationScheduleDescription' => 'Gli articoli della rivista possono essere pubblicati tutti insieme, come parte di un numero completo, con un sommario definitivo. In alternativa, gli articoli possono essere pubblicati singolarmente, appena pronti, e venendo cos&#x00EC; aggiunti al sommario di volta in volta. Indicate ai lettori, nella pagina delle informazioni sulla rivista, sia il il metodo utilizzato per la pubblicazione, sia la frequenza.',
  ...
  'manager.setup.searchDescription.description' => 'Inserire una breve descrizione della testata (50-300 caratteri) che i motori di ricerca possono visulizzare nei risultati di ricerca.',
  ...
  'manager.setup.disableSubmissions.notAccepting' => 'Questa testata non accetta nuovi articoli. Verificare le impostazioni per consentire nuove sottomissioni.',
...
Selezionare una delle metriche configurate come predefinita.
  ...
  'manager.statistics.statistics.count.accept' => 'Proposte accettate (%):',
  'manager.statistics.statistics.count.decline' => 'Proposte rifiutate (%):',
  'manager.statistics.statistics.count.revise' => 'Proposte accettate dopo modifiche (%):',
  ...
  'manager.statistics.reports.filters.byContext.description' => 'Restringe i risultati per contesto (fascicolo e/o articolo).',
  'manager.statistics.reports.filters.byObject.description' => 'Restringe i risultati per tipo di oggetto (rivista, fascicolo, articolo, gabbia PDF, altre gabbie) e/o per uno o più id.',
  ...
  'plugins.importexport.common.error.unknownJournal' => 'Il path specificato, "{$journalPath}", non esiste.',
  ...
  'manager.setup.metadata.coverage' => 'Ambito',
  'manager.setup.metadata.coverage.description' => '
riferisce alla locazione geografica, all\'ambito cronologico o storico, "
alle caratteristiche del campione di ricerca."',
  'manager.setup.customTags' => 'Marcatori personalizzati',
  'manager.setup.customTagsDescription' => '
HTML personalizzati da inserire nell\'header di ogni pagina (ad "
tag META)."',
  'manager.setup.publishingMode' => 'Accesso al contenuto della rivista',
  'manager.statistics.statistics.registeredUsers' => 'Utenti registrati (comprende lo staff della rivista):',
  'manager.setup.layout' => 'Layout della rivista',
  'manager.setup.faviconInvalid' => '
formato per la favicon. Formati accettati sono ico, .png, e .gif."',
  'manager.setup.journalThumbnail.altText' => 'Testo alternativo per la thumbnail',
  'manager.setup.enableArchive' => 'Attiva l\'Archiving',
  'manager.setup.porticoEnable' => '
Portico per conservare e distribuire il contenuto delle rivista "
biblioteche che partecipano a Portico."',
  'manager.setup.porticoTitle' => 'Portico',
  'manager.setup.editorialTeam.description' => '
editori, direttori, responsabili e altri individui associati con "
rivista."',
);